...
@section('content')
    <div class="max-width-1200">
        ...
        <x-core-setting::section
            :title="trans('plugins/ecommerce::ecommerce.setting.hours_allocated')"
            :description="trans('plugins/ecommerce::ecommerce.setting.hours_allocated_description')"
        >
            <div class="form-group row">
                <label for="daily_hours" class="col-md-3" style="width: 140px">
                    {{ trans('plugins/ecommerce::ecommerce.setting.daily_hours') }}
                </label>
                <div class="col-md-9">
                    <input name="daily_hours" type="text" class="numberic" value="{{ get_ecommerce_setting('daily_hours') }}">
                </div>
            </div>
            <div class="form-group row">
                <label for="weekend_hours" class="col-md-3" style="width: 140px">
                    {{ trans('plugins/ecommerce::ecommerce.setting.weekend_hours') }}
                </label>
                <div class="col-md-9">
                    <input name="weekend_hours" type="text" class="numberic weekend_hours" value="{{ get_ecommerce_setting('weekend_hours') }}">
                </div>
            </div>
            <div class="form-group row">
                <label for="weekly_hours" class="col-md-3" style="width: 140px">
                    {{ trans('plugins/ecommerce::ecommerce.setting.weekly_hours') }}
                </label>
                <div class="col-md-9">
                    <input name="weekly_hours" type="text" class="numberic weekly_hours" value="{{ get_ecommerce_setting('weekly_hours') }}">
                </div>
            </div>
            <div class="form-group row">
                <label for="monthly_hours" class="col-md-3" style="width: 140px">
                    {{ trans('plugins/ecommerce::ecommerce.setting.monthly_hours') }}
                </label>
                <div class="col-md-9">
                    <input name="monthly_hours" type="text" class="numberic monthly_hours" value="{{ get_ecommerce_setting('monthly_hours') }}">
                </div>
            </div>
        </x-core-setting::section>
                ...
                @foreach ($storeLocators as $storeLocator)
                    <tr>
                        ...
                        <td>
                            ...
                            <span>{{ $storeLocator->zip_code }}</span>
                        </td>
                        <td>
