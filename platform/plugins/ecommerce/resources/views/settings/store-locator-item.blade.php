...
<div class="next-form-section">
    ...
    <div class="next-form-grid">
        ...
        <div class="next-form-grid-cell">
            <label class="text-title-field" for="zip_code">{{ trans('plugins/ecommerce::store-locator.zip_code') }}</label>
            <input type="text" class="next-input" name="zip_code" id="zip_code" value="{{ $locator ? $locator->zip_code : null }}">
        </div>
    </div>
    ...
    <div class="next-form-grid">
        ...
        <div class="next-form-grid-cell" style="display: flex; justify-content: space-between; align-items: baseline;">
            <label for="colorInput" class="form-label">Calendar Color</label>
            <input type="color" name="color" class="form-control form-control-color" id="colorInput" value="{{ $locator ? $locator->color : '#FFFFFF' }}" title="Choose your color">
        </div>
    </div>
