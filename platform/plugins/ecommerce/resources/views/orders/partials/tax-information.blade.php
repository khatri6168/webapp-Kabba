<div class="customer-tax-information-form">
    <div class="form-group mb-3">
        ...
        <label for="with_tax_information" class="control-label ps-2">{{ __("Requires company invoice (Please fill in your company information to receive the invoice)?") }}</label>
    </div>
