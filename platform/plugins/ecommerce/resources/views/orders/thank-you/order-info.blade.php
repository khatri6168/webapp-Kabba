<div class="pt-3 mb-4">
    ...
    <div class="checkout-success-products">
        <div class="row show-cart-row d-md-none p-2">
            ...
            <div class="col-3">
                <p class="text-end mobile-total"><strong> {{ format_price($order->amount) }} </strong></p>
            </div>
        </div>
            ...
            @foreach ($order->products as $orderProduct)
                <div class="row cart-item">
                    ...
                    <div class="col-lg-5 col-md-5">
                        ...
                        <p class="mb-0"> Schedule Date: {{$orderProduct->options['deldate']}}</p>
                        <p class="mb-0">
                    ...
                    <div class="col-lg-4 col-md-4 col-4 float-end text-end">
                        <p><strong>{{ format_price($orderProduct->price) }}</strong></p>
                    </div>
                </div> <!--  /item -->
            @endforeach
