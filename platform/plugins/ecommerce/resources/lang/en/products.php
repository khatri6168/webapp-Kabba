...
return [
    ...
    'form' => [
        ...
        'request_delivery_option' => 'Request Delivery Option',
        'delivery_and_pick' => 'Delivery and Pickup',
        'delivery_and_pick_description' => '(Price for each direction)',
        'store_pickup' => 'I\'ll Pick Up In Store ',
    ...
    'prorated_hourly_overage_cost' => 'Prorated Hourly Overage Cost',
    'hour_tracking' => 'Hour Tracking',
    'hours_allocated_helper' => 'Adjust "Hours Allocated" under "Basic Settings"',
    'in_store_pickup' => 'In Store Pick Up',
];
