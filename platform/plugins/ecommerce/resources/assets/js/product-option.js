        ...
        addFromGlobalOption(optionId) {
            ...
            axios
                ...
                .then(function(res) {
                    ...
                    const html = self.generateOptionTemplate(option, self.productOptions.length - 1)
                    console.log("🚀 ~ file: product-option.js:136 ~ .then ~ option:", option)
                ...
                if (optionType === 'Field') {
                    ...
                    if (values.length > 0) {
                        ...
                        $.each(values, function(key, value) {
                            ...
                            const commentText = (value.value_type === 1) ? 'selected' : ''
                            console.log("🚀 ~ file: product-option.js:220 ~ $.each ~ value:", value)
                            valuesResult += valueTemplate
                                ...
                                .replace(/__addComment__/g, 'Add Comment')
                        })
