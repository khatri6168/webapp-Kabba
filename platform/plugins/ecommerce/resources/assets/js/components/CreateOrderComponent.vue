                                ...
                                <table class='table-normal table-none-border table-color-gray-text text-end'>
                                    ...
                                    <tr class='text-no-bold'>
                                        <td colspan='2'>
                                            ...
                                            <input type="hidden" name="is_custom_reorder_status" v-model="is_custom_reorder" value="1">
                                            <input type="hidden" name="old_order_value" v-model="old_order_id">
                                            <div v-if='is_custom_reorder' class='ui-select-wrapper'>
                                                <select class='ui-select'>
                                                    <option selected="selected" value='bank_transfer'>{{
                                                            __('Card On File from Original Order')
                                                        }}
                                                    </option>
                                                </select>
                                            ...
                                            <div v-else class='ui-select-wrapper'>
                ...
                <div class='pd-all-10-20 border-top-color'>
                    <div class='row'>
                        ...
                        <div class='col-12 col-sm-6 col-md-12 col-lg-6 text-end'>
                            <button v-if="is_custom_reorder" class='btn btn-success' v-b-modal.make-paid>
                                {{ __('Process Order') }}
                            </button>
                            <button v-else class='btn btn-success' v-b-modal.make-paid
                                    :disabled="!child_product_ids.length || child_payment_method == 'cod'">
                                {{ __('order.paid') }}
                            </button>
                            <button v-if="!is_custom_reorder" class='btn btn-primary ml15' v-b-modal.make-pending
