...
use Botble\Ecommerce\Repositories\Eloquent\EmployeeRepository;
...
use Botble\Ecommerce\Repositories\Eloquent\OrderMachineHourRepository;
use Botble\Ecommerce\Repositories\Eloquent\DeliveryPickupRepository;
...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(OrderMachineHourInterface::class, function () {
            return new OrderMachineHourRepository(new OrderMachineHour());
        });

        $this->app->bind(DeliveryPickUpInterface::class, function () {
            return new DeliveryPickupRepository(new DeliveryPickup());
        });
    ...
    public function boot(): void
    {
        ...
        $this->app['events']->listen(RouteMatched::class, function () {
            DashboardMenu::make()
                ...
                ->registerItem([
                    'id' => 'cms-plugins-ecommerce.delivery-pickup',
                    'priority' => 3,
                    'parent_id' => 'cms-plugins-ecommerce',
                    'name' => 'plugins/ecommerce::deliveries.name',
                    'icon' => 'fa fa-calendar',
                ...
                ->registerItem([
                    'id' => 'cms-plugins-employees',
                    'priority' => 14,
                    'parent_id' => 'cms-plugins-ecommerce',
                    'name' => 'plugins/ecommerce::employees.name',
                    'icon' => 'fa fa-user',
