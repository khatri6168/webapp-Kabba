...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix() . '/ecommerce', 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'employees', 'as' => 'employees.'], function () {
            ...
            Route::delete('items/destroy', [
                'as' => 'deletes',
                'uses' => 'EmployeeController@deletes',
//                'permission' => 'stores.destroy',
            ]);
        });

        // routes for delivery & pickup
        Route::group(['prefix' => 'deliveries', 'as' => 'deliveries.'], function () {
            Route::resource('', 'DeliveryPickUpController')
                ->parameters(['' => 'delivery']);

            Route::delete('items/destroy', [
                'as' => 'deletes',
                'uses' => 'DeliveryPickUpController@deletes',
                'permission' => 'deliveries.destroy',
            ]);

            Route::post('update-comment/{id}', [
                'as' => 'update-comment',
                'uses' => 'DeliveryPickUpController@updateComment',
            ...
            Route::post('update-status', [
                'as' => 'update-status',
                'uses' => 'DeliveryPickUpController@updateStatus',
                'permission' => 'deliveries.edit',
            ])->wherePrimaryKey();

            Route::get('calendar', [
                'as' => 'calendar',
                'uses' => 'DeliveryPickUpController@calendar',
                'permission' => 'deliveries.calendar',
            ]);
        });
