...
if (! defined('EMPLOYEE_MODULE_SCREEN_NAME')) {
    define('EMPLOYEE_MODULE_SCREEN_NAME', 'employee');
}
...
if (! defined('RENTAL_TYPE_DAILY')) {
    define('RENTAL_TYPE_DAILY', 1);
}

if (! defined('RENTAL_TYPE_WEEKEND')) {
    define('RENTAL_TYPE_WEEKEND', 2);
}

if (! defined('RENTAL_TYPE_WEEKLY')) {
    define('RENTAL_TYPE_WEEKLY', 3);
}

if (! defined('RENTAL_TYPE_MONTHLY')) {
    define('RENTAL_TYPE_MONTHLY', 4);
}

if (! defined('DELIVERY_PICKUP_TYPE_DELIVERY')) {
    define('DELIVERY_PICKUP_TYPE_DELIVERY', 1);
}

if (! defined('DELIVERY_PICKUP_TYPE_PICKUP')) {
    define('DELIVERY_PICKUP_TYPE_PICKUP', 2);
}

if (! defined('CUSTOMER_DELIVERY')) {
    define('CUSTOMER_DELIVERY', 1);
}

if (! defined('CUSTOMER_PICKUP')) {
    define('CUSTOMER_PICKUP', 1);
}

if (! defined('SHOP_DELIVERY')) {
    define('SHOP_DELIVERY', 2);
}

if (! defined('SHOP_PICKUP')) {
    define('SHOP_PICKUP', 2);
}
